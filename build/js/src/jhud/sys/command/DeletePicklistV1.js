...
export default class DeletePicklistV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:sys:command:delete-picklist:1-0-0', DeletePicklistV1,
      [],
      [
...
MessageResolver.register('jhud:sys:command:delete-picklist', DeletePicklistV1);
