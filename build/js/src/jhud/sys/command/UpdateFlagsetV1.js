// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/sys/command/update-flagset/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:sys:command:update-flagset:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:sys:command:update-flagset';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:sys:command:update-flagset:v1';
