...
export default class PromotionMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:promotion-marked-as-draft:1-0-0', PromotionMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:promotion-marked-as-draft', PromotionMarkedAsDraftV1);
