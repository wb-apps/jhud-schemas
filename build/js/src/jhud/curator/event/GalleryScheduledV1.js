...
export default class GalleryScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:gallery-scheduled:1-0-0', GalleryScheduledV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:gallery-scheduled', GalleryScheduledV1);
