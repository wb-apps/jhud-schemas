...
export default class TeaserPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:teaser-published:1-0-0', TeaserPublishedV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:teaser-published', TeaserPublishedV1);
