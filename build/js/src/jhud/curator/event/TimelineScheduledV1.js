...
export default class TimelineScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:timeline-scheduled:1-0-0', TimelineScheduledV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:timeline-scheduled', TimelineScheduledV1);
