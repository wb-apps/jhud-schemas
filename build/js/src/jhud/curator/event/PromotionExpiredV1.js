...
export default class PromotionExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:promotion-expired:1-0-0', PromotionExpiredV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:promotion-expired', PromotionExpiredV1);
