...
export default class GalleryUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:gallery-updated:1-0-0', GalleryUpdatedV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:gallery-updated', GalleryUpdatedV1);
