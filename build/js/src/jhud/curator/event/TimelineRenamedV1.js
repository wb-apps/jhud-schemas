...
export default class TimelineRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:timeline-renamed:1-0-0', TimelineRenamedV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:timeline-renamed', TimelineRenamedV1);
