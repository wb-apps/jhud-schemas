...
export default class TimelinePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:event:timeline-published:1-0-0', TimelinePublishedV1,
      [],
      [
...
MessageResolver.register('jhud:curator:event:timeline-published', TimelinePublishedV1);
