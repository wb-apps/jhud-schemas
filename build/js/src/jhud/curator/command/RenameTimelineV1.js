...
export default class RenameTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:command:rename-timeline:1-0-0', RenameTimelineV1,
      [],
      [
...
MessageResolver.register('jhud:curator:command:rename-timeline', RenameTimelineV1);
