// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/command/remove-teaser-slotting/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:curator:command:remove-teaser-slotting:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:curator:command:remove-teaser-slotting';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:curator:command:remove-teaser-slotting:v1';
