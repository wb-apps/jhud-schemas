...
export default class DeleteGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:command:delete-gallery:1-0-0', DeleteGalleryV1,
      [],
      [
...
MessageResolver.register('jhud:curator:command:delete-gallery', DeleteGalleryV1);
