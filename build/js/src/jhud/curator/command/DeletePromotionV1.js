...
export default class DeletePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:command:delete-promotion:1-0-0', DeletePromotionV1,
      [],
      [
...
MessageResolver.register('jhud:curator:command:delete-promotion', DeletePromotionV1);
