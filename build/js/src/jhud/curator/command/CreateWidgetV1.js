...
export default class CreateWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:command:create-widget:1-0-0', CreateWidgetV1,
      [],
      [
...
MessageResolver.register('jhud:curator:command:create-widget', CreateWidgetV1);
