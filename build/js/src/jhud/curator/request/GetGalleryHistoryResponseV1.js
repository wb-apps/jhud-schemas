...
export default class GetGalleryHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:request:get-gallery-history-response:1-0-0', GetGalleryHistoryResponseV1,
      [],
      [
...
MessageResolver.register('jhud:curator:request:get-gallery-history-response', GetGalleryHistoryResponseV1);
