...
export default class GetWidgetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:request:get-widget-response:1-0-0', GetWidgetResponseV1,
      [],
      [
...
MessageResolver.register('jhud:curator:request:get-widget-response', GetWidgetResponseV1);
