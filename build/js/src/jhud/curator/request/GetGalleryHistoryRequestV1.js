...
export default class GetGalleryHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:request:get-gallery-history-request:1-0-0', GetGalleryHistoryRequestV1,
      [],
      [
...
MessageResolver.register('jhud:curator:request:get-gallery-history-request', GetGalleryHistoryRequestV1);
