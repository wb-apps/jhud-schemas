// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/person-teaser/1-0-0.json#
...
export default class PersonTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:person-teaser:1-0-0', PersonTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:person-teaser', PersonTeaserV1);
