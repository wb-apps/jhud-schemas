// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/gallery-teaser/1-0-0.json#
...
export default class GalleryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:gallery-teaser:1-0-0', GalleryTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:gallery-teaser', GalleryTeaserV1);
