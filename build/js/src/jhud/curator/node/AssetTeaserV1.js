// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/asset-teaser/1-0-0.json#
...
export default class AssetTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:asset-teaser:1-0-0', AssetTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:asset-teaser', AssetTeaserV1);
