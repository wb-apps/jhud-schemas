// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/gallery-widget/1-0-0.json#
...
export default class GalleryWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:gallery-widget:1-0-0', GalleryWidgetV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:gallery-widget', GalleryWidgetV1);
