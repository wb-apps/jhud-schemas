// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/video-teaser/1-0-0.json#
...
export default class VideoTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:video-teaser:1-0-0', VideoTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:video-teaser', VideoTeaserV1);
