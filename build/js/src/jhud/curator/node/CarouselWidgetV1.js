// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/carousel-widget/1-0-0.json#
...
export default class CarouselWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:carousel-widget:1-0-0', CarouselWidgetV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:carousel-widget', CarouselWidgetV1);
