// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/gallery/1-0-0.json#
...
export default class GalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:gallery:1-0-0', GalleryV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:gallery', GalleryV1);
