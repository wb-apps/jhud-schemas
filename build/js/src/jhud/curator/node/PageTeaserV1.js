// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/page-teaser/1-0-0.json#
...
export default class PageTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:page-teaser:1-0-0', PageTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:page-teaser', PageTeaserV1);
