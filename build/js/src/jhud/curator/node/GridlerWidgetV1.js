// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/gridler-widget/1-0-0.json#
...
export default class GridlerWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:gridler-widget:1-0-0', GridlerWidgetV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:gridler-widget', GridlerWidgetV1);
