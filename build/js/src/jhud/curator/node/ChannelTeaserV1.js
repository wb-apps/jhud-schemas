// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/channel-teaser/1-0-0.json#
...
export default class ChannelTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:channel-teaser:1-0-0', ChannelTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:channel-teaser', ChannelTeaserV1);
