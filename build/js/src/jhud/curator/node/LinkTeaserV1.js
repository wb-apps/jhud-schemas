// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/link-teaser/1-0-0.json#
...
export default class LinkTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:link-teaser:1-0-0', LinkTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:link-teaser', LinkTeaserV1);
