// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/poll-teaser/1-0-0.json#
...
export default class PollTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:poll-teaser:1-0-0', PollTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:poll-teaser', PollTeaserV1);
