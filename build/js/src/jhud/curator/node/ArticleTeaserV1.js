// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/article-teaser/1-0-0.json#
...
export default class ArticleTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:article-teaser', ArticleTeaserV1);
