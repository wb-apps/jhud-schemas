// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/playlist-widget/1-0-0.json#
...
export default class PlaylistWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:playlist-widget:1-0-0', PlaylistWidgetV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:playlist-widget', PlaylistWidgetV1);
