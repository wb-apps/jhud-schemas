// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/category-teaser/1-0-0.json#
...
export default class CategoryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:category-teaser:1-0-0', CategoryTeaserV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:category-teaser', CategoryTeaserV1);
