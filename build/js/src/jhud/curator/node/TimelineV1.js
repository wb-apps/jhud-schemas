// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/curator/node/timeline/1-0-0.json#
...
export default class TimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:curator:node:timeline:1-0-0', TimelineV1,
      [],
      [
...
MessageResolver.register('jhud:curator:node:timeline', TimelineV1);
