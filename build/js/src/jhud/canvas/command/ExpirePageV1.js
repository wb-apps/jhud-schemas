// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/canvas/command/expire-page/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:canvas:command:expire-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:canvas:command:expire-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:expire-page:v1';
