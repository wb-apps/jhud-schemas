// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/canvas/command/mark-page-as-pending/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:canvas:command:mark-page-as-pending:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:canvas:command:mark-page-as-pending';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:mark-page-as-pending:v1';
