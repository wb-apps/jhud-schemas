// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/canvas/event/page-scheduled/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:canvas:event:page-scheduled:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:canvas:event:page-scheduled';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-scheduled:v1';
