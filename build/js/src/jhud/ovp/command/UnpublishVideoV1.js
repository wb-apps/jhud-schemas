...
export default class UnpublishVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:ovp:command:unpublish-video:1-0-0', UnpublishVideoV1,
      [],
      [
...
MessageResolver.register('jhud:ovp:command:unpublish-video', UnpublishVideoV1);
