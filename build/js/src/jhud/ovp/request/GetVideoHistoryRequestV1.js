...
export default class GetVideoHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:ovp:request:get-video-history-request:1-0-0', GetVideoHistoryRequestV1,
      [],
      [
...
MessageResolver.register('jhud:ovp:request:get-video-history-request', GetVideoHistoryRequestV1);
