...
export default class GetPersonHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:people:request:get-person-history-response:1-0-0', GetPersonHistoryResponseV1,
      [],
      [
...
MessageResolver.register('jhud:people:request:get-person-history-response', GetPersonHistoryResponseV1);
