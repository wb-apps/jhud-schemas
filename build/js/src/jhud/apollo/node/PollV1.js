// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/apollo/node/poll/1-0-0.json#
...
export default class PollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:apollo:node:poll:1-0-0', PollV1,
      [],
      [
...
MessageResolver.register('jhud:apollo:node:poll', PollV1);
