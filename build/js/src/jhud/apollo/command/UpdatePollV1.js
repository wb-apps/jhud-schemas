// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/apollo/command/update-poll/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:apollo:command:update-poll:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:apollo:command:update-poll';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:update-poll:v1';
