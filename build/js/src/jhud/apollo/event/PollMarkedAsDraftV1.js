...
export default class PollMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:apollo:event:poll-marked-as-draft:1-0-0', PollMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('jhud:apollo:event:poll-marked-as-draft', PollMarkedAsDraftV1);
