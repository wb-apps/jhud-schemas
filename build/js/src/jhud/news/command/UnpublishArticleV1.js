...
export default class UnpublishArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:news:command:unpublish-article:1-0-0', UnpublishArticleV1,
      [],
      [
...
MessageResolver.register('jhud:news:command:unpublish-article', UnpublishArticleV1);
