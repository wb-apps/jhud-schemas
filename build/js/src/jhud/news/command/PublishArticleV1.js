...
export default class PublishArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:news:command:publish-article:1-0-0', PublishArticleV1,
      [],
      [
...
MessageResolver.register('jhud:news:command:publish-article', PublishArticleV1);
