// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/news/command/create-article/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:news:command:create-article:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:news:command:create-article';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:news:command:create-article:v1';
