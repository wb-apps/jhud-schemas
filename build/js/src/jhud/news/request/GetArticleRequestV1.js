...
export default class GetArticleRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:news:request:get-article-request:1-0-0', GetArticleRequestV1,
      [],
      [
...
MessageResolver.register('jhud:news:request:get-article-request', GetArticleRequestV1);
