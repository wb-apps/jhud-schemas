...
export default class UpdateSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:boost:command:update-sponsor:1-0-0', UpdateSponsorV1,
      [],
      [
...
MessageResolver.register('jhud:boost:command:update-sponsor', UpdateSponsorV1);
