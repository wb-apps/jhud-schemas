...
export default class SponsorRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:boost:event:sponsor-renamed:1-0-0', SponsorRenamedV1,
      [],
      [
...
MessageResolver.register('jhud:boost:event:sponsor-renamed', SponsorRenamedV1);
