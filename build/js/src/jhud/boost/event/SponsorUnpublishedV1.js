...
export default class SponsorUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:boost:event:sponsor-unpublished:1-0-0', SponsorUnpublishedV1,
      [],
      [
...
MessageResolver.register('jhud:boost:event:sponsor-unpublished', SponsorUnpublishedV1);
