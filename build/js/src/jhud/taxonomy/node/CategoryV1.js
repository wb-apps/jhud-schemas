// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/taxonomy/node/category/1-0-0.json#
...
export default class CategoryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:taxonomy:node:category:1-0-0', CategoryV1,
      [],
      [
...
MessageResolver.register('jhud:taxonomy:node:category', CategoryV1);
