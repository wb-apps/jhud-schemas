...
export default class GetCategoryHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:taxonomy:request:get-category-history-response:1-0-0', GetCategoryHistoryResponseV1,
      [],
      [
...
MessageResolver.register('jhud:taxonomy:request:get-category-history-response', GetCategoryHistoryResponseV1);
