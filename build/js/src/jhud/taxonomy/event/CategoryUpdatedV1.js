...
export default class CategoryUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:taxonomy:event:category-updated:1-0-0', CategoryUpdatedV1,
      [],
      [
...
MessageResolver.register('jhud:taxonomy:event:category-updated', CategoryUpdatedV1);
