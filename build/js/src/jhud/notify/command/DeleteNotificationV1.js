// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/notify/command/delete-notification/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:notify:command:delete-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:notify:command:delete-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:notify:command:delete-notification:v1';
