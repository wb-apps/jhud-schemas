// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/notify/node/android-notification/1-0-0.json#
...
export default class AndroidNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:notify:node:android-notification:1-0-0', AndroidNotificationV1,
      [],
      [
...
MessageResolver.register('jhud:notify:node:android-notification', AndroidNotificationV1);
