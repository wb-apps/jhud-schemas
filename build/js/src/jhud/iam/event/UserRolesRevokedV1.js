// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/iam/event/user-roles-revoked/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:iam:event:user-roles-revoked:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:iam:event:user-roles-revoked';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:iam:event:user-roles-revoked:v1';
