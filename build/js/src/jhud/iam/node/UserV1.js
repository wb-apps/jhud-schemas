...
import GdbotsIamUserV1Mixin from '@gdbots/schemas/gdbots/iam/mixin/user/UserV1Mixin.js';
...
const M = UserV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:iam:node:user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:iam:node:user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:iam:node:user:v1';
