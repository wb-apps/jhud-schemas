...
import GdbotsIamSlackAppV1Mixin from '@gdbots/schemas/gdbots/iam/mixin/slack-app/SlackAppV1Mixin.js';
...
const M = SlackAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:iam:node:slack-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:iam:node:slack-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:iam:node:slack-app:v1';
