...
import GdbotsIamSmsAppV1Mixin from '@gdbots/schemas/gdbots/iam/mixin/sms-app/SmsAppV1Mixin.js';
...
const M = SmsAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:iam:node:sms-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:iam:node:sms-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:iam:node:sms-app:v1';
