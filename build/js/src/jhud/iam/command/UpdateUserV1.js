// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/iam/command/update-user/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:iam:command:update-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:iam:command:update-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:iam:command:update-user:v1';
