// @link https://schemas.jenniferhudsonshow.com/json-schema/jhud/iam/command/create-app/1-0-0.json#
...
const M = CreateAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:iam:command:create-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:iam:command:create-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:iam:command:create-app:v1';
