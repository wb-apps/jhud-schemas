...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:jhud:iam:command:grant-roles-to-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'jhud:iam:command:grant-roles-to-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'jhud:iam:command:grant-roles-to-app:v1';
