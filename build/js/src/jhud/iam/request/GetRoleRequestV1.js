...
export default class GetRoleRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:iam:request:get-role-request:1-0-0', GetRoleRequestV1,
      [],
      [
...
MessageResolver.register('jhud:iam:request:get-role-request', GetRoleRequestV1);
