...
export default class GetUserHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:jhud:iam:request:get-user-history-request:1-0-0', GetUserHistoryRequestV1,
      [],
      [
...
MessageResolver.register('jhud:iam:request:get-user-history-request', GetUserHistoryRequestV1);
