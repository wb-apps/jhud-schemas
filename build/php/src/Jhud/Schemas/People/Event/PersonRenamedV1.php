...
{
    const SCHEMA_ID = 'pbj:jhud:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:event:person-renamed:v1';
    const MIXINS = [
