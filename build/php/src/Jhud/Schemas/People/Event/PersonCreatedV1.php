...
{
    const SCHEMA_ID = 'pbj:jhud:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:event:person-created:v1';
    const MIXINS = [
