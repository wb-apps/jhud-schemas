...
{
    const SCHEMA_ID = 'pbj:jhud:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:event:person-deleted:v1';
    const MIXINS = [
