...
namespace Jhud\Schemas\People\Event;
...
{
    const SCHEMA_ID = 'pbj:jhud:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:event:person-updated:v1';
    const MIXINS = [
