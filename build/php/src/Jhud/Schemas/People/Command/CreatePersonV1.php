...
namespace Jhud\Schemas\People\Command;
...
{
    const SCHEMA_ID = 'pbj:jhud:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:command:create-person:v1';
    const MIXINS = [
