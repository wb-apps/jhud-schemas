...
{
    const SCHEMA_ID = 'pbj:jhud:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:command:rename-person:v1';
    const MIXINS = [
