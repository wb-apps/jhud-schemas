...
{
    const SCHEMA_ID = 'pbj:jhud:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:command:update-person:v1';
    const MIXINS = [
