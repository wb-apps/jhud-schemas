...
{
    const SCHEMA_ID = 'pbj:jhud:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:command:delete-person:v1';
    const MIXINS = [
