...
{
    const SCHEMA_ID = 'pbj:jhud:people:request:search-people-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:request:search-people-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:request:search-people-request:v1';
    const MIXINS = [
