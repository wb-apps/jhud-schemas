...
{
    const SCHEMA_ID = 'pbj:jhud:people:request:get-person-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:request:get-person-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:request:get-person-history-request:v1';
    const MIXINS = [
