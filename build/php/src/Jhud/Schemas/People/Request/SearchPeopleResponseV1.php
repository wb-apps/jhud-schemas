...
{
    const SCHEMA_ID = 'pbj:jhud:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:request:search-people-response:v1';
    const MIXINS = [
