...
{
    const SCHEMA_ID = 'pbj:jhud:people:request:get-person-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:request:get-person-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:request:get-person-response:v1';
    const MIXINS = [
