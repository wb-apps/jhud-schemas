...
namespace Jhud\Schemas\People\Request;
...
{
    const SCHEMA_ID = 'pbj:jhud:people:request:get-person-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:people:request:get-person-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:people:request:get-person-history-response:v1';
    const MIXINS = [
