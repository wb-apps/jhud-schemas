...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-published:v1';
    const MIXINS = [
