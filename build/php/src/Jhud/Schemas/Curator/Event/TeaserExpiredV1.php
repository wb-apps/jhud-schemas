...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-expired:v1';
    const MIXINS = [
