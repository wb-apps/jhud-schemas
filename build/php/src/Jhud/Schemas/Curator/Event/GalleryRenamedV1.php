...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-renamed:v1';
    const MIXINS = [
