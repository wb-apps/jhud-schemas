...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:widget-created:v1';
    const MIXINS = [
