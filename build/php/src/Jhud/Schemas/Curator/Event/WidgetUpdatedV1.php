...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:widget-updated:v1';
    const MIXINS = [
