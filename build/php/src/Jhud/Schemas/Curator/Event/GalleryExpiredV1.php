...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-expired:v1';
    const MIXINS = [
