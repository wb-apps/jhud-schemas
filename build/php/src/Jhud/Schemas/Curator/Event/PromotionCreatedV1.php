...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:promotion-created:v1';
    const MIXINS = [
