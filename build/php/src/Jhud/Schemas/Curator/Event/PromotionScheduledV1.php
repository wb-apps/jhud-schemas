...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:promotion-scheduled:v1';
    const MIXINS = [
