...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-marked-as-draft:v1';
    const MIXINS = [
