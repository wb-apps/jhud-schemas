...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:promotion-updated:v1';
    const MIXINS = [
