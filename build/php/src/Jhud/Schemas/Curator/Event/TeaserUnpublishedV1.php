...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-unpublished:v1';
    const MIXINS = [
