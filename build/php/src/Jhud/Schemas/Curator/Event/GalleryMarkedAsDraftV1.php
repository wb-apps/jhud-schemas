...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-marked-as-draft:v1';
    const MIXINS = [
