...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-scheduled:v1';
    const MIXINS = [
