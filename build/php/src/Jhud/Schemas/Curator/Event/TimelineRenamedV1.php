...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-renamed:v1';
    const MIXINS = [
