...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-created:v1';
    const MIXINS = [
