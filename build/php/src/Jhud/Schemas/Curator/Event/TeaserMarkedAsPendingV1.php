...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-marked-as-pending:v1';
    const MIXINS = [
