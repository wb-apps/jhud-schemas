...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-deleted:v1';
    const MIXINS = [
