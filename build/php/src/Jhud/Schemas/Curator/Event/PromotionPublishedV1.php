...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:promotion-published:v1';
    const MIXINS = [
