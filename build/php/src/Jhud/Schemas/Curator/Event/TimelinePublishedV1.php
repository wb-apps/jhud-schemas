...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-published:v1';
    const MIXINS = [
