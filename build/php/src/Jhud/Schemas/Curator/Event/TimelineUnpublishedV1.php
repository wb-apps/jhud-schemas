...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-unpublished:v1';
    const MIXINS = [
