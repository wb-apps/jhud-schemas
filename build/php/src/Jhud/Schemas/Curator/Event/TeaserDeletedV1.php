...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-deleted:v1';
    const MIXINS = [
