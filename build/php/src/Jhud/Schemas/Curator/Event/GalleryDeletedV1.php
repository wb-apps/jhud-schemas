...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-deleted:v1';
    const MIXINS = [
