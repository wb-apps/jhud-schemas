...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-image-count-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-image-count-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-image-count-updated:v1';
    const MIXINS = [
