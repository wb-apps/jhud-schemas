...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-created:v1';
    const MIXINS = [
