...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-scheduled:v1';
    const MIXINS = [
