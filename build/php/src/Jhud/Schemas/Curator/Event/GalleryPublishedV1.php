...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-published:v1';
    const MIXINS = [
