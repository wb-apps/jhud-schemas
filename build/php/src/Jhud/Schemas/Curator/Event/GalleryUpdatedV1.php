...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-updated:v1';
    const MIXINS = [
