...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:promotion-unpublished:v1';
    const MIXINS = [
