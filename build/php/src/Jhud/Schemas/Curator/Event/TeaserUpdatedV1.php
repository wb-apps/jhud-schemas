...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:teaser-updated:v1';
    const MIXINS = [
