...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-scheduled:v1';
    const MIXINS = [
