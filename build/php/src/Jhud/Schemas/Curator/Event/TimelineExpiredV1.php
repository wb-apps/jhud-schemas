...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-expired:v1';
    const MIXINS = [
