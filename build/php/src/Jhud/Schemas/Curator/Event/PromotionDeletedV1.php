...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:promotion-deleted:v1';
    const MIXINS = [
