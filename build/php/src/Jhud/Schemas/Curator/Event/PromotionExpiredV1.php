...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:promotion-expired:v1';
    const MIXINS = [
