...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-unpublished:v1';
    const MIXINS = [
