...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:widget-deleted:v1';
    const MIXINS = [
