...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:gallery-created:v1';
    const MIXINS = [
