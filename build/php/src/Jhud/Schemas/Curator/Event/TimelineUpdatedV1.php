...
{
    const SCHEMA_ID = 'pbj:jhud:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:event:timeline-updated:v1';
    const MIXINS = [
