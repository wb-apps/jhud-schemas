...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:rename-gallery:v1';
    const MIXINS = [
