...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:rename-timeline:v1';
    const MIXINS = [
