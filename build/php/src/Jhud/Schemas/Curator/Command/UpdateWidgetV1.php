...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:update-widget:v1';
    const MIXINS = [
