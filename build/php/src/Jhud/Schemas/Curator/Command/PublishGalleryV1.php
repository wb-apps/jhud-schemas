...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:publish-gallery:v1';
    const MIXINS = [
