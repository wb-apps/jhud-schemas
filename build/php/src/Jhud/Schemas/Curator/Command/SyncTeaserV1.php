...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:sync-teaser:v1';
    const MIXINS = [
