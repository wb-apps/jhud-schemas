...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:expire-timeline:v1';
    const MIXINS = [
