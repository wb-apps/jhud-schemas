...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:delete-promotion:v1';
    const MIXINS = [
