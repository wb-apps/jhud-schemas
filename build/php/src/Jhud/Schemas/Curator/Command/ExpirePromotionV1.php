...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:expire-promotion:v1';
    const MIXINS = [
