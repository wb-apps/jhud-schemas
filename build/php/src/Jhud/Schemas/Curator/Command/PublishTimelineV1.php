...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:publish-timeline:v1';
    const MIXINS = [
