...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:unpublish-promotion:v1';
    const MIXINS = [
