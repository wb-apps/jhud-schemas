...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:create-widget:v1';
    const MIXINS = [
