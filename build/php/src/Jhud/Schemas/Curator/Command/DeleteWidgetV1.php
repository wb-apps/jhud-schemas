...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:delete-widget:v1';
    const MIXINS = [
