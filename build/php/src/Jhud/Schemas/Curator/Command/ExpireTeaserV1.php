...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:expire-teaser:v1';
    const MIXINS = [
