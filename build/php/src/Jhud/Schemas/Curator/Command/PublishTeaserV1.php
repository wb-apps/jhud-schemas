...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:publish-teaser:v1';
    const MIXINS = [
