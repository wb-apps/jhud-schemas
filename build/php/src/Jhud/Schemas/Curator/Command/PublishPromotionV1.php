...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:publish-promotion:v1';
    const MIXINS = [
