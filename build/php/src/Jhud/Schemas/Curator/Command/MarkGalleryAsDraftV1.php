...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:mark-gallery-as-draft:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:mark-gallery-as-draft';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:mark-gallery-as-draft:v1';
    const MIXINS = [
