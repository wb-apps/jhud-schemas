...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:delete-timeline:v1';
    const MIXINS = [
