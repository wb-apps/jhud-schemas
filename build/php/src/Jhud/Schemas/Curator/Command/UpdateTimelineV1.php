...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:update-timeline:v1';
    const MIXINS = [
