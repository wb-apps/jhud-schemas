...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:unpublish-gallery:v1';
    const MIXINS = [
