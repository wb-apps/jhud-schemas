...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:expire-gallery:v1';
    const MIXINS = [
