...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:delete-gallery:v1';
    const MIXINS = [
