...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:delete-teaser:v1';
    const MIXINS = [
