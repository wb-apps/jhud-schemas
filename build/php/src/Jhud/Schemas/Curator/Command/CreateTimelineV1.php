...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:create-timeline:v1';
    const MIXINS = [
