...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:create-promotion:v1';
    const MIXINS = [
