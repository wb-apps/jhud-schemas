...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:mark-gallery-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:mark-gallery-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:mark-gallery-as-pending:v1';
    const MIXINS = [
