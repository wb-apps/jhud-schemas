...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:unpublish-teaser:v1';
    const MIXINS = [
