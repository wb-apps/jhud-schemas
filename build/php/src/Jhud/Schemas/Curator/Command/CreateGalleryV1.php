...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:create-gallery:v1';
    const MIXINS = [
