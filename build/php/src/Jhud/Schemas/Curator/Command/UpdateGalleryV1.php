...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:update-gallery:v1';
    const MIXINS = [
