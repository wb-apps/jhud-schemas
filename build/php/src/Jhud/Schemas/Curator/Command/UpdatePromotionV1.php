...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:update-promotion:v1';
    const MIXINS = [
