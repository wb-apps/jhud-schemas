...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:create-teaser:v1';
    const MIXINS = [
