...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:update-teaser:v1';
    const MIXINS = [
