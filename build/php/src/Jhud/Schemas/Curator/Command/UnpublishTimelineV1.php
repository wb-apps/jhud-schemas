...
{
    const SCHEMA_ID = 'pbj:jhud:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:command:unpublish-timeline:v1';
    const MIXINS = [
