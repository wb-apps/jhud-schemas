...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:get-gallery-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:get-gallery-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:get-gallery-request:v1';
    const MIXINS = [
