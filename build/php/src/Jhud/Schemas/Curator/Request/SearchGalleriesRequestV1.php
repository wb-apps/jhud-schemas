...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-galleries-request:v1';
    const MIXINS = [
