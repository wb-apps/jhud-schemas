...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-teasers-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-teasers-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-teasers-response:v1';
    const MIXINS = [
