...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:render-widget-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:render-widget-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:render-widget-request:v1';
    const MIXINS = [
