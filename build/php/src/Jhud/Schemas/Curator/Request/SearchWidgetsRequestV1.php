...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-widgets-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-widgets-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-widgets-request:v1';
    const MIXINS = [
