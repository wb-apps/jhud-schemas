...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-timelines-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-timelines-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-timelines-response:v1';
    const MIXINS = [
