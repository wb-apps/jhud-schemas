...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-promotions-request:v1';
    const MIXINS = [
