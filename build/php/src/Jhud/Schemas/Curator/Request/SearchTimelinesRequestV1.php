...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-timelines-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-timelines-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-timelines-request:v1';
    const MIXINS = [
