...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:get-promotion-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:get-promotion-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:get-promotion-request:v1';
    const MIXINS = [
