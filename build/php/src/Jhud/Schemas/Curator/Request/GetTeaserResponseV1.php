...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:get-teaser-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:get-teaser-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:get-teaser-response:v1';
    const MIXINS = [
