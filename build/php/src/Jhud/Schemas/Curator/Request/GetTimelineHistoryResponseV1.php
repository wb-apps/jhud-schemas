...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:get-timeline-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:get-timeline-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:get-timeline-history-response:v1';
    const MIXINS = [
