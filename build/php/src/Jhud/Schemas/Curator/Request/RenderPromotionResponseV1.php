...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:render-promotion-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:render-promotion-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:render-promotion-response:v1';
    const MIXINS = [
