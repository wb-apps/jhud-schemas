...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-promotions-response:v1';
    const MIXINS = [
