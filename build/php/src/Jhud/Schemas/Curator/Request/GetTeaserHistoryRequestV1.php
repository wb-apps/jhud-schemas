...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:get-teaser-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:get-teaser-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:get-teaser-history-request:v1';
    const MIXINS = [
