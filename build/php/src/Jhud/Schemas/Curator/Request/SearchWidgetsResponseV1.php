...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-widgets-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-widgets-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-widgets-response:v1';
    const MIXINS = [
