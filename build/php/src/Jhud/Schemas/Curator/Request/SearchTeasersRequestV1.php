...
{
    const SCHEMA_ID = 'pbj:jhud:curator:request:search-teasers-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:request:search-teasers-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:request:search-teasers-request:v1';
    const MIXINS = [
