...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:page-teaser:v1';
    const MIXINS = [
