...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:channel-teaser:v1';
    const MIXINS = [
