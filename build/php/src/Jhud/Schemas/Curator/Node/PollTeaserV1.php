...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:poll-teaser:v1';
    const MIXINS = [
