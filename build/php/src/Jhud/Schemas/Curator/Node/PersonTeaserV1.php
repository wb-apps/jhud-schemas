...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:person-teaser:v1';
    const MIXINS = [
