...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:blogroll-widget:v1';
    const MIXINS = [
