...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:article-teaser:v1';
    const MIXINS = [
