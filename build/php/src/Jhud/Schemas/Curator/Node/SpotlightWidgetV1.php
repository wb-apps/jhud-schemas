...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:spotlight-widget:v1';
    const MIXINS = [
