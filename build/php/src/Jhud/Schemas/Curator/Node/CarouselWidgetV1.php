...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:carousel-widget:v1';
    const MIXINS = [
