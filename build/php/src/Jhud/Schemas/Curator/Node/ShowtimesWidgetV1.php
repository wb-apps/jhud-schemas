...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:showtimes-widget:v1';
    const MIXINS = [
