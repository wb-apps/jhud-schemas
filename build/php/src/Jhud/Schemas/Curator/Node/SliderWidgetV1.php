...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:slider-widget:v1';
    const MIXINS = [
