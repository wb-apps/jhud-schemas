...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:playlist-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:playlist-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:playlist-widget:v1';
    const MIXINS = [
