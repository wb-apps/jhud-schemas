...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:gridler-widget:v1';
    const MIXINS = [
