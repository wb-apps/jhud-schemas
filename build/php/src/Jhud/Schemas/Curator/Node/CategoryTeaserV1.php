...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:category-teaser:v1';
    const MIXINS = [
