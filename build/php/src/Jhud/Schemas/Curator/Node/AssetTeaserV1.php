...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:asset-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:asset-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:asset-teaser:v1';
    const MIXINS = [
