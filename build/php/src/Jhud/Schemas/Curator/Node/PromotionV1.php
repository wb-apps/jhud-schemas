...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:promotion:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:promotion';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:promotion:v1';
    const MIXINS = [
