...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:video-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:video-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:video-teaser:v1';
    const MIXINS = [
