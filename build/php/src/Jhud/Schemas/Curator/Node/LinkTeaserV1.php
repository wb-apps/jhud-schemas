...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:link-teaser:v1';
    const MIXINS = [
