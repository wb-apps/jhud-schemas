...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:timeline:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:timeline';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:timeline:v1';
    const MIXINS = [
