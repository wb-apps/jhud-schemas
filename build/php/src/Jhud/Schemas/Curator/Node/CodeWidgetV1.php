...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:code-widget:v1';
    const MIXINS = [
