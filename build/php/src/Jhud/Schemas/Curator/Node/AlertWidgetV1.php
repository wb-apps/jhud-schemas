...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:alert-widget:v1';
    const MIXINS = [
