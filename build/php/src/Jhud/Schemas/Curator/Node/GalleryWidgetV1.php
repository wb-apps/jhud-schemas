...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:gallery-widget:v1';
    const MIXINS = [
