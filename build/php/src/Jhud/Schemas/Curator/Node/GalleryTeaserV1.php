...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:gallery-teaser:v1';
    const MIXINS = [
