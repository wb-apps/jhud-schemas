...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:timeline-teaser:v1';
    const MIXINS = [
