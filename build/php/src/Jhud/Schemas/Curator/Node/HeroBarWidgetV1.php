...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:hero-bar-widget:v1';
    const MIXINS = [
