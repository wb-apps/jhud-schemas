...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:media-list-widget:v1';
    const MIXINS = [
