...
{
    const SCHEMA_ID = 'pbj:jhud:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'jhud:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'jhud:curator:node:ad-widget:v1';
    const MIXINS = [
