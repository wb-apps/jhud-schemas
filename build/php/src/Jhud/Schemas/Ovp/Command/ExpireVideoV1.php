...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:expire-video:v1';
    const MIXINS = [
