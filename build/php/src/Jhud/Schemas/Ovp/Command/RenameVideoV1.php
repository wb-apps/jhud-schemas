...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:rename-video:v1';
    const MIXINS = [
