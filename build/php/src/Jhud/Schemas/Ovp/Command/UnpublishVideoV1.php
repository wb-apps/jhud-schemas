...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:unpublish-video:v1';
    const MIXINS = [
