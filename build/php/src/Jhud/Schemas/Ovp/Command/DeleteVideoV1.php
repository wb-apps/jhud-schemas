...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:delete-video:v1';
    const MIXINS = [
