...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:update-video:v1';
    const MIXINS = [
