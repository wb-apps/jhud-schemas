...
namespace Jhud\Schemas\Ovp\Command;
...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:mark-video-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:mark-video-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:mark-video-as-pending:v1';
    const MIXINS = [
