...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:publish-video:v1';
    const MIXINS = [
