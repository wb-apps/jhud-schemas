...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:command:create-video:v1';
    const MIXINS = [
