...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-scheduled:v1';
    const MIXINS = [
