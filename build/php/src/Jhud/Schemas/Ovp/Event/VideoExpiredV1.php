...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-expired:v1';
    const MIXINS = [
