...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-deleted:v1';
    const MIXINS = [
