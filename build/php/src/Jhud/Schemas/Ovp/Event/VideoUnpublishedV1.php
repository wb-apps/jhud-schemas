...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-unpublished:v1';
    const MIXINS = [
