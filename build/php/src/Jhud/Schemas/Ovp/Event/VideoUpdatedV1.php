...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-updated:v1';
    const MIXINS = [
