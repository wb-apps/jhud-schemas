...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-renamed:v1';
    const MIXINS = [
