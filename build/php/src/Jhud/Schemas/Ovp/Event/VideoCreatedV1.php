...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-created:v1';
    const MIXINS = [
