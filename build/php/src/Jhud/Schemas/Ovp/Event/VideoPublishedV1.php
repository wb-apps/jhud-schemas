...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:event:video-published:v1';
    const MIXINS = [
