...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:request:search-videos-request:v1';
    const MIXINS = [
