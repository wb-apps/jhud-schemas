...
namespace Jhud\Schemas\Ovp\Request;
...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:request:get-video-history-response:v1';
    const MIXINS = [
