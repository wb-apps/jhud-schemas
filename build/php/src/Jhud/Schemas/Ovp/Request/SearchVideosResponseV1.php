...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:request:search-videos-response:v1';
    const MIXINS = [
