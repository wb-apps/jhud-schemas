...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:request:get-video-request:v1';
    const MIXINS = [
