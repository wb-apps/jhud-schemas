...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:request:get-video-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:request:get-video-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:request:get-video-history-request:v1';
    const MIXINS = [
