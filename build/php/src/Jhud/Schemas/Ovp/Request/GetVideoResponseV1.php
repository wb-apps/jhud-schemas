...
{
    const SCHEMA_ID = 'pbj:jhud:ovp:request:get-video-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:ovp:request:get-video-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:ovp:request:get-video-response:v1';
    const MIXINS = [
