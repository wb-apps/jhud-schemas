...
{
    const SCHEMA_ID = 'pbj:jhud:news:node:article-stats:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:node:article-stats';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:node:article-stats:v1';
    const MIXINS = [
