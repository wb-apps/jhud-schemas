...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:create-article:v1';
    const MIXINS = [
