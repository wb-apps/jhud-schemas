...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:mark-article-as-draft:v1';
    const MIXINS = [
