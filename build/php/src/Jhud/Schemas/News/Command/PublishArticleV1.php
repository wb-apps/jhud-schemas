...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:publish-article:v1';
    const MIXINS = [
