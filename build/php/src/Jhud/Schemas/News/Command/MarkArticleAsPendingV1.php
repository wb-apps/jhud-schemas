...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:mark-article-as-pending:v1';
    const MIXINS = [
