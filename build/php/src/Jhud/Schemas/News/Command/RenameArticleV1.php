...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:rename-article:v1';
    const MIXINS = [
