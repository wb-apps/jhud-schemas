...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:update-article:v1';
    const MIXINS = [
