...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:unpublish-article:v1';
    const MIXINS = [
