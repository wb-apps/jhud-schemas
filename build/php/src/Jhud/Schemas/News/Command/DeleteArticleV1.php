...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:delete-article:v1';
    const MIXINS = [
