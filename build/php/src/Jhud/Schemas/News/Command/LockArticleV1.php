...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:lock-article:v1';
    const MIXINS = [
