...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:collect-article-stats:v1';
    const MIXINS = [
