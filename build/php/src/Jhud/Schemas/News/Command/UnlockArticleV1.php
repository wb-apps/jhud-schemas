...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:unlock-article:v1';
    const MIXINS = [
