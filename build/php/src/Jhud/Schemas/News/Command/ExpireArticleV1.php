...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:expire-article:v1';
    const MIXINS = [
