...
{
    const SCHEMA_ID = 'pbj:jhud:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:command:remove-article-slotting:v1';
    const MIXINS = [
