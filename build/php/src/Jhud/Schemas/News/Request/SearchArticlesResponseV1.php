...
{
    const SCHEMA_ID = 'pbj:jhud:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:request:search-articles-response:v1';
    const MIXINS = [
