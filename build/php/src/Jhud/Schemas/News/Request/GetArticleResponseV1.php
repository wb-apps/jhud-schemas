...
{
    const SCHEMA_ID = 'pbj:jhud:news:request:get-article-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:request:get-article-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:request:get-article-response:v1';
    const MIXINS = [
