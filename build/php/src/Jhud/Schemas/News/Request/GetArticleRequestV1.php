...
{
    const SCHEMA_ID = 'pbj:jhud:news:request:get-article-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:request:get-article-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:request:get-article-request:v1';
    const MIXINS = [
