...
{
    const SCHEMA_ID = 'pbj:jhud:news:request:get-article-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:request:get-article-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:request:get-article-history-request:v1';
    const MIXINS = [
