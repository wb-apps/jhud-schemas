...
{
    const SCHEMA_ID = 'pbj:jhud:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:request:search-articles-request:v1';
    const MIXINS = [
