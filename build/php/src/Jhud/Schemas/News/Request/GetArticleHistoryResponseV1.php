...
{
    const SCHEMA_ID = 'pbj:jhud:news:request:get-article-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:request:get-article-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:request:get-article-history-response:v1';
    const MIXINS = [
