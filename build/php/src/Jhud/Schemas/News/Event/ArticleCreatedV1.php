...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-created:v1';
    const MIXINS = [
