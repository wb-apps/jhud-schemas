...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:apple-news-article-synced:v1';
    const MIXINS = [
