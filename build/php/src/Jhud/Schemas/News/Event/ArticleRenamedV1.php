...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-renamed:v1';
    const MIXINS = [
