...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-deleted:v1';
    const MIXINS = [
