...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-stats-collected:v1';
    const MIXINS = [
