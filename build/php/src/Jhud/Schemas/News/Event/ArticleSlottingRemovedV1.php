...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-slotting-removed:v1';
    const MIXINS = [
