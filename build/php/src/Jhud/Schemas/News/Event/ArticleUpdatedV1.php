...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-updated:v1';
    const MIXINS = [
