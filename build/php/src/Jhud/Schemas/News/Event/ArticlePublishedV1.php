...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-published:v1';
    const MIXINS = [
