...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-locked:v1';
    const MIXINS = [
