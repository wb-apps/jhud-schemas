...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-expired:v1';
    const MIXINS = [
