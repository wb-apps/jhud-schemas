...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-scheduled:v1';
    const MIXINS = [
