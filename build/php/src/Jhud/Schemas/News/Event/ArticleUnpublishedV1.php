...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-unpublished:v1';
    const MIXINS = [
