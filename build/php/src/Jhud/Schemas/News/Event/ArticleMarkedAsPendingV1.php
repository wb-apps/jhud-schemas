...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-marked-as-pending:v1';
    const MIXINS = [
