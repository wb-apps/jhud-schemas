...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-unlocked:v1';
    const MIXINS = [
