...
{
    const SCHEMA_ID = 'pbj:jhud:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'jhud:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'jhud:news:event:article-marked-as-draft:v1';
    const MIXINS = [
