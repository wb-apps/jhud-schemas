...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:android-notification:v1';
    const MIXINS = [
