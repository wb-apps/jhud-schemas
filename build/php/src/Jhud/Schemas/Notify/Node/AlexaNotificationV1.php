...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:alexa-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:alexa-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:alexa-notification:v1';
    const MIXINS = [
