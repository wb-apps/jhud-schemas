...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:sms-notification:v1';
    const MIXINS = [
