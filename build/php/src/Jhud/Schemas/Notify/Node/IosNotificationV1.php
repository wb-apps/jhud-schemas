...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:ios-notification:v1';
    const MIXINS = [
