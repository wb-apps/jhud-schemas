...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:browser-notification:v1';
    const MIXINS = [
