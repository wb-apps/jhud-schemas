...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:twitter-notification:v1';
    const MIXINS = [
