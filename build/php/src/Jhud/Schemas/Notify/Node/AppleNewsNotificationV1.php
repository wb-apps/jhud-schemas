...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:apple-news-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:apple-news-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:apple-news-notification:v1';
    const MIXINS = [
