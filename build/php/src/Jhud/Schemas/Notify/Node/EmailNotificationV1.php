...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:email-notification:v1';
    const MIXINS = [
