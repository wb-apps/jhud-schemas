...
{
    const SCHEMA_ID = 'pbj:jhud:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:node:slack-notification:v1';
    const MIXINS = [
