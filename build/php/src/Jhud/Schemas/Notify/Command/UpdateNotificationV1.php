...
namespace Jhud\Schemas\Notify\Command;
...
{
    const SCHEMA_ID = 'pbj:jhud:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:command:update-notification:v1';
    const MIXINS = [
