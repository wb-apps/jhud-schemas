...
{
    const SCHEMA_ID = 'pbj:jhud:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:command:delete-notification:v1';
    const MIXINS = [
