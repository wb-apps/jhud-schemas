...
{
    const SCHEMA_ID = 'pbj:jhud:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:command:send-notification:v1';
    const MIXINS = [
