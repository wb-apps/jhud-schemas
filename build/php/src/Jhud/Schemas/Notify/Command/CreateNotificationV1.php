...
{
    const SCHEMA_ID = 'pbj:jhud:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:command:create-notification:v1';
    const MIXINS = [
