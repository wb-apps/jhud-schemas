...
{
    const SCHEMA_ID = 'pbj:jhud:notify:request:get-notification-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:request:get-notification-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:request:get-notification-history-response:v1';
    const MIXINS = [
