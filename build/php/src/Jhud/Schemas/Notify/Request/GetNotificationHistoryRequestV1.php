...
namespace Jhud\Schemas\Notify\Request;
...
{
    const SCHEMA_ID = 'pbj:jhud:notify:request:get-notification-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:request:get-notification-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:request:get-notification-history-request:v1';
    const MIXINS = [
