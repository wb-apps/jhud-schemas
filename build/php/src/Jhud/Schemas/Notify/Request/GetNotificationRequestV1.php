...
{
    const SCHEMA_ID = 'pbj:jhud:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:request:get-notification-request:v1';
    const MIXINS = [
