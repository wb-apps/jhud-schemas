...
{
    const SCHEMA_ID = 'pbj:jhud:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:request:search-notifications-response:v1';
    const MIXINS = [
