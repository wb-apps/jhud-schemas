...
{
    const SCHEMA_ID = 'pbj:jhud:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:request:search-notifications-request:v1';
    const MIXINS = [
