...
{
    const SCHEMA_ID = 'pbj:jhud:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:event:notification-created:v1';
    const MIXINS = [
