...
{
    const SCHEMA_ID = 'pbj:jhud:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:event:notification-sent:v1';
    const MIXINS = [
