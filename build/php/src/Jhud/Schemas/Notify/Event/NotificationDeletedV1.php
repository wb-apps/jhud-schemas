...
{
    const SCHEMA_ID = 'pbj:jhud:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:event:notification-deleted:v1';
    const MIXINS = [
