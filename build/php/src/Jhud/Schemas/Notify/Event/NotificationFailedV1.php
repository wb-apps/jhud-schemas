...
{
    const SCHEMA_ID = 'pbj:jhud:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:event:notification-failed:v1';
    const MIXINS = [
