...
{
    const SCHEMA_ID = 'pbj:jhud:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:notify:event:notification-updated:v1';
    const MIXINS = [
