...
{
    const SCHEMA_ID = 'pbj:jhud:dam:request:get-upload-urls-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:request:get-upload-urls-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:request:get-upload-urls-request:v1';
    const MIXINS = [
