...
{
    const SCHEMA_ID = 'pbj:jhud:dam:request:get-upload-urls-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:request:get-upload-urls-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:request:get-upload-urls-response:v1';
    const MIXINS = [
