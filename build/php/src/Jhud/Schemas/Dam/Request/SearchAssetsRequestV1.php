...
{
    const SCHEMA_ID = 'pbj:jhud:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:request:search-assets-request:v1';
    const MIXINS = [
