...
{
    const SCHEMA_ID = 'pbj:jhud:dam:request:get-asset-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:request:get-asset-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:request:get-asset-history-request:v1';
    const MIXINS = [
