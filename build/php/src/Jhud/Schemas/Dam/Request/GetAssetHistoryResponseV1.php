...
namespace Jhud\Schemas\Dam\Request;
...
{
    const SCHEMA_ID = 'pbj:jhud:dam:request:get-asset-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:request:get-asset-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:request:get-asset-history-response:v1';
    const MIXINS = [
