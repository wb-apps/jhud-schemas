...
{
    const SCHEMA_ID = 'pbj:jhud:dam:request:get-asset-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:request:get-asset-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:request:get-asset-request:v1';
    const MIXINS = [
