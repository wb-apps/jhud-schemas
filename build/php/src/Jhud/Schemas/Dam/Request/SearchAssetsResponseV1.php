...
{
    const SCHEMA_ID = 'pbj:jhud:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:request:search-assets-response:v1';
    const MIXINS = [
