...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:asset-linked:v1';
    const MIXINS = [
