...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:asset-created:v1';
    const MIXINS = [
