...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:asset-updated:v1';
    const MIXINS = [
