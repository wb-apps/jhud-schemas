...
namespace Jhud\Schemas\Dam\Event;
...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:gallery-asset-reordered:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:gallery-asset-reordered';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:gallery-asset-reordered:v1';
    const MIXINS = [
