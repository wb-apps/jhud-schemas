...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:asset-deleted:v1';
    const MIXINS = [
