...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:asset-unlinked:v1';
    const MIXINS = [
