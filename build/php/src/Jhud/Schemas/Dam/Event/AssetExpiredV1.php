...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:asset-expired:v1';
    const MIXINS = [
