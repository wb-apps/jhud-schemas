...
{
    const SCHEMA_ID = 'pbj:jhud:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:event:asset-patched:v1';
    const MIXINS = [
