...
{
    const SCHEMA_ID = 'pbj:jhud:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:command:delete-asset:v1';
    const MIXINS = [
