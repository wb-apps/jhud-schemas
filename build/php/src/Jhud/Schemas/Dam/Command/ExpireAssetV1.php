...
{
    const SCHEMA_ID = 'pbj:jhud:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:command:expire-asset:v1';
    const MIXINS = [
