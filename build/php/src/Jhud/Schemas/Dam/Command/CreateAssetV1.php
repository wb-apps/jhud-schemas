...
{
    const SCHEMA_ID = 'pbj:jhud:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:command:create-asset:v1';
    const MIXINS = [
