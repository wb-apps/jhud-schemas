...
{
    const SCHEMA_ID = 'pbj:jhud:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:command:unlink-assets:v1';
    const MIXINS = [
