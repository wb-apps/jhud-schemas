...
{
    const SCHEMA_ID = 'pbj:jhud:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:command:link-assets:v1';
    const MIXINS = [
