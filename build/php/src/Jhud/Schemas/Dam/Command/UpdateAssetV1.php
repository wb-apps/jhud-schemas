...
{
    const SCHEMA_ID = 'pbj:jhud:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:command:update-asset:v1';
    const MIXINS = [
