...
{
    const SCHEMA_ID = 'pbj:jhud:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:command:patch-assets:v1';
    const MIXINS = [
