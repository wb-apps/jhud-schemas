...
{
    const SCHEMA_ID = 'pbj:jhud:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:node:archive-asset:v1';
    const MIXINS = [
