...
{
    const SCHEMA_ID = 'pbj:jhud:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'jhud:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'jhud:dam:node:unknown-asset:v1';
    const MIXINS = [
