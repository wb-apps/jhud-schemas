...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:redirect-updated:v1';
    const MIXINS = [
