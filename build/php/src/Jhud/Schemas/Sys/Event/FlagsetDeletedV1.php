...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:flagset-deleted:v1';
    const MIXINS = [
