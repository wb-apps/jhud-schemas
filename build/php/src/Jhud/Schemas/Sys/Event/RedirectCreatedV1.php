...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:redirect-created:v1';
    const MIXINS = [
