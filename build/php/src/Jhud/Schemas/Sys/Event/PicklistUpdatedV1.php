...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:picklist-updated:v1';
    const MIXINS = [
