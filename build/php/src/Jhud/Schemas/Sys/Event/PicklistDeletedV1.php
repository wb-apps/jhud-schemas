...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:picklist-deleted:v1';
    const MIXINS = [
