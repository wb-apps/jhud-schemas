...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:redirect-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:redirect-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:redirect-deleted:v1';
    const MIXINS = [
