...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:flagset-created:v1';
    const MIXINS = [
