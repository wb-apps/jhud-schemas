...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:flagset-updated:v1';
    const MIXINS = [
