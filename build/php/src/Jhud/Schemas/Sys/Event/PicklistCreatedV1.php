...
{
    const SCHEMA_ID = 'pbj:jhud:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:event:picklist-created:v1';
    const MIXINS = [
