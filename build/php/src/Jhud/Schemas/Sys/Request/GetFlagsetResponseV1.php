...
{
    const SCHEMA_ID = 'pbj:jhud:sys:request:get-flagset-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:request:get-flagset-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:request:get-flagset-response:v1';
    const MIXINS = [
