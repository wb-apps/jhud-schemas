...
{
    const SCHEMA_ID = 'pbj:jhud:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:request:search-redirects-request:v1';
    const MIXINS = [
