...
{
    const SCHEMA_ID = 'pbj:jhud:sys:request:list-all-flagsets-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:request:list-all-flagsets-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:request:list-all-flagsets-request:v1';
    const MIXINS = [
