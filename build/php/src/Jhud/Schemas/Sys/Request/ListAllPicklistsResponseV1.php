...
{
    const SCHEMA_ID = 'pbj:jhud:sys:request:list-all-picklists-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:request:list-all-picklists-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:request:list-all-picklists-response:v1';
    const MIXINS = [
