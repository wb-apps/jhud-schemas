...
{
    const SCHEMA_ID = 'pbj:jhud:sys:request:get-flagset-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:request:get-flagset-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:request:get-flagset-request:v1';
    const MIXINS = [
