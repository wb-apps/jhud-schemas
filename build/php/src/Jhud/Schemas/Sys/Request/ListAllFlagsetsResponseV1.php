...
{
    const SCHEMA_ID = 'pbj:jhud:sys:request:list-all-flagsets-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:request:list-all-flagsets-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:request:list-all-flagsets-response:v1';
    const MIXINS = [
