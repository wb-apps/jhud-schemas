...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:update-flagset:v1';
    const MIXINS = [
