...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:create-redirect:v1';
    const MIXINS = [
