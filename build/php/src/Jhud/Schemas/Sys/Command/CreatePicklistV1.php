...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:create-picklist:v1';
    const MIXINS = [
