...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:delete-picklist:v1';
    const MIXINS = [
