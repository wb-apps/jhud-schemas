...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:delete-flagset:v1';
    const MIXINS = [
