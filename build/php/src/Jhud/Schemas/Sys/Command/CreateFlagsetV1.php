...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:create-flagset:v1';
    const MIXINS = [
