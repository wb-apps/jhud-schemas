...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:update-picklist:v1';
    const MIXINS = [
