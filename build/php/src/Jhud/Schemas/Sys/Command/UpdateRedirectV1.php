...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:update-redirect:v1';
    const MIXINS = [
