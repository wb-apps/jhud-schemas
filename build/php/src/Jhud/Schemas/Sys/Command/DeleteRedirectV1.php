...
namespace Jhud\Schemas\Sys\Command;
...
{
    const SCHEMA_ID = 'pbj:jhud:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'jhud:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'jhud:sys:command:delete-redirect:v1';
    const MIXINS = [
