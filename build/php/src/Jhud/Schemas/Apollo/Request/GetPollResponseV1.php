...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:request:get-poll-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:request:get-poll-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:request:get-poll-response:v1';
    const MIXINS = [
