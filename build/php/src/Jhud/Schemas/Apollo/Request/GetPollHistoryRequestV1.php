...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:request:get-poll-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:request:get-poll-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:request:get-poll-history-request:v1';
    const MIXINS = [
