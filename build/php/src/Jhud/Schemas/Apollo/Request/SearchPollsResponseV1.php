...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:request:search-polls-response:v1';
    const MIXINS = [
