...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:request:search-polls-request:v1';
    const MIXINS = [
