...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:node:poll-stats:v1';
    const MIXINS = [
