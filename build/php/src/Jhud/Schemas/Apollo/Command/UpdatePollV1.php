...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:update-poll:v1';
    const MIXINS = [
