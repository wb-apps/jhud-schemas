...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:unpublish-poll:v1';
    const MIXINS = [
