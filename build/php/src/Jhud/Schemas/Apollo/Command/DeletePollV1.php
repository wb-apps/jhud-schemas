...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:delete-poll:v1';
    const MIXINS = [
