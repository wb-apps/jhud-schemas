...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:create-poll:v1';
    const MIXINS = [
