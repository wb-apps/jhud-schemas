...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:publish-poll:v1';
    const MIXINS = [
