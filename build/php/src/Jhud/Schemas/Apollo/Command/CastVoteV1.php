...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:cast-vote:v1';
    const MIXINS = [
