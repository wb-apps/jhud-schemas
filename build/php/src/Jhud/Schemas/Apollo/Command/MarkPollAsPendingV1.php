...
namespace Jhud\Schemas\Apollo\Command;
...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:mark-poll-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:mark-poll-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:mark-poll-as-pending:v1';
    const MIXINS = [
