...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:command:expire-poll:v1';
    const MIXINS = [
