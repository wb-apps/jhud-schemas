...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-unpublished:v1';
    const MIXINS = [
