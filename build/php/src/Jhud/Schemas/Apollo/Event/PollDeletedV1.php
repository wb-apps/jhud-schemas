...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-deleted:v1';
    const MIXINS = [
