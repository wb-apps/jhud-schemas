...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-published:v1';
    const MIXINS = [
