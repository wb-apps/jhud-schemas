...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-scheduled:v1';
    const MIXINS = [
