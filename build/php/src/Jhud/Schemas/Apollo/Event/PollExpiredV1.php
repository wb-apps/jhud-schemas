...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-expired:v1';
    const MIXINS = [
