...
namespace Jhud\Schemas\Apollo\Event;
...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-marked-as-pending:v1';
    const MIXINS = [
