...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:vote-casted:v1';
    const MIXINS = [
