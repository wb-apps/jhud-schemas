...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-created:v1';
    const MIXINS = [
