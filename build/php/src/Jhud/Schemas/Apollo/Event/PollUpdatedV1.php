...
{
    const SCHEMA_ID = 'pbj:jhud:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:apollo:event:poll-updated:v1';
    const MIXINS = [
