...
{
    const SCHEMA_ID = 'pbj:jhud:iam:node:apple-news-app:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:node:apple-news-app';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:node:apple-news-app:v1';
    const MIXINS = [
