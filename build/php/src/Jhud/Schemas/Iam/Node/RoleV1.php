...
namespace Jhud\Schemas\Iam\Node;
...
{
    const SCHEMA_ID = 'pbj:jhud:iam:node:role:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:node:role';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:node:role:v1';
    const MIXINS = [
