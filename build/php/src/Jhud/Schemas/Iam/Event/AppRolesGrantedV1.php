...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:app-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:app-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:app-roles-granted:v1';
    const MIXINS = [
