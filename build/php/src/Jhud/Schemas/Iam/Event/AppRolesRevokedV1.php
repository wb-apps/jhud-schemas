...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:app-roles-revoked:v1';
    const MIXINS = [
