...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:role-updated:v1';
    const MIXINS = [
