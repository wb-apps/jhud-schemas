...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:user-roles-revoked:v1';
    const MIXINS = [
