...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:app-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:app-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:app-updated:v1';
    const MIXINS = [
