...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:app-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:app-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:app-created:v1';
    const MIXINS = [
