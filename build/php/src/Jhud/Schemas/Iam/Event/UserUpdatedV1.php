...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:user-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:user-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:user-updated:v1';
    const MIXINS = [
