...
namespace Jhud\Schemas\Iam\Event;
...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:user-roles-granted:v1';
    const MIXINS = [
