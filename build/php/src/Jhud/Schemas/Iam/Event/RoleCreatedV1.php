...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:role-created:v1';
    const MIXINS = [
