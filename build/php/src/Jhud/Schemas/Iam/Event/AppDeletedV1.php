...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:app-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:app-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:app-deleted:v1';
    const MIXINS = [
