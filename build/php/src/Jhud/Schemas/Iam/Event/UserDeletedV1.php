...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:user-deleted:v1';
    const MIXINS = [
