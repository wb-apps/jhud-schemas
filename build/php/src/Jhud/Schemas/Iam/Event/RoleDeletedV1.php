...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:role-deleted:v1';
    const MIXINS = [
