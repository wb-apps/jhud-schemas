...
{
    const SCHEMA_ID = 'pbj:jhud:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:event:user-created:v1';
    const MIXINS = [
