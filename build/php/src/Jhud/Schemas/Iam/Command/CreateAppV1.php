...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:create-app:v1';
    const MIXINS = [
