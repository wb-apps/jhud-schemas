...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:update-app:v1';
    const MIXINS = [
