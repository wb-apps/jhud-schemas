...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:delete-role:v1';
    const MIXINS = [
