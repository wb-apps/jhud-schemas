...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:create-user:v1';
    const MIXINS = [
