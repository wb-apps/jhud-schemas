...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:create-role:v1';
    const MIXINS = [
