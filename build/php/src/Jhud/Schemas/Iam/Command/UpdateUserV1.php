...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:update-user:v1';
    const MIXINS = [
