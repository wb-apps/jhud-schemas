...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:update-role:v1';
    const MIXINS = [
