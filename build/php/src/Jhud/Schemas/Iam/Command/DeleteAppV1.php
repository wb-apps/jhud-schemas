...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:delete-app:v1';
    const MIXINS = [
