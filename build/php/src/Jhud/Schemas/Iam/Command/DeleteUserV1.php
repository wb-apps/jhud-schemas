...
{
    const SCHEMA_ID = 'pbj:jhud:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:command:delete-user:v1';
    const MIXINS = [
