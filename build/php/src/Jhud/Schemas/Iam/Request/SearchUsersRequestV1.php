...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:search-users-request:v1';
    const MIXINS = [
