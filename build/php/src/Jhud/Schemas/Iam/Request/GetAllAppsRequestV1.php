...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:get-all-apps-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:get-all-apps-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:get-all-apps-request:v1';
    const MIXINS = [
