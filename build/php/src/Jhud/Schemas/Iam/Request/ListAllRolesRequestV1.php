...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:list-all-roles-request:v1';
    const MIXINS = [
