...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:get-app-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:get-app-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:get-app-history-response:v1';
    const MIXINS = [
