...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:list-all-roles-response:v1';
    const MIXINS = [
