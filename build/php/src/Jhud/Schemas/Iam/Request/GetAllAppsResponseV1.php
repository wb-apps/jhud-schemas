...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:get-all-apps-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:get-all-apps-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:get-all-apps-response:v1';
    const MIXINS = [
