...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:get-app-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:get-app-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:get-app-response:v1';
    const MIXINS = [
