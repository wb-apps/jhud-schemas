...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:get-app-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:get-app-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:get-app-history-request:v1';
    const MIXINS = [
