...
{
    const SCHEMA_ID = 'pbj:jhud:iam:request:get-user-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:iam:request:get-user-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:iam:request:get-user-history-request:v1';
    const MIXINS = [
