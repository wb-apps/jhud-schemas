...
{
    const SCHEMA_ID = 'pbj:jhud:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:command:expire-sponsor:v1';
    const MIXINS = [
