...
{
    const SCHEMA_ID = 'pbj:jhud:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:command:publish-sponsor:v1';
    const MIXINS = [
