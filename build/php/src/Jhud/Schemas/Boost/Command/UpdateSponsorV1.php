...
{
    const SCHEMA_ID = 'pbj:jhud:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:command:update-sponsor:v1';
    const MIXINS = [
