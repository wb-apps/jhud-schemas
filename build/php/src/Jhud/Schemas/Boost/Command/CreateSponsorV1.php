...
{
    const SCHEMA_ID = 'pbj:jhud:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:command:create-sponsor:v1';
    const MIXINS = [
