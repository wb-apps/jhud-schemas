...
{
    const SCHEMA_ID = 'pbj:jhud:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:command:rename-sponsor:v1';
    const MIXINS = [
