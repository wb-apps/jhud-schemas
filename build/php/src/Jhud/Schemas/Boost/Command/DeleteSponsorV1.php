...
{
    const SCHEMA_ID = 'pbj:jhud:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:command:delete-sponsor:v1';
    const MIXINS = [
