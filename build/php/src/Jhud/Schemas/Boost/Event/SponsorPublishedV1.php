...
{
    const SCHEMA_ID = 'pbj:jhud:boost:event:sponsor-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:event:sponsor-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:event:sponsor-published:v1';
    const MIXINS = [
