...
{
    const SCHEMA_ID = 'pbj:jhud:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:event:sponsor-deleted:v1';
    const MIXINS = [
