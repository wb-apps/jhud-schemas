...
{
    const SCHEMA_ID = 'pbj:jhud:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:event:sponsor-created:v1';
    const MIXINS = [
