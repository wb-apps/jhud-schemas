...
{
    const SCHEMA_ID = 'pbj:jhud:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:event:sponsor-renamed:v1';
    const MIXINS = [
