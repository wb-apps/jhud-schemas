...
{
    const SCHEMA_ID = 'pbj:jhud:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:event:sponsor-expired:v1';
    const MIXINS = [
