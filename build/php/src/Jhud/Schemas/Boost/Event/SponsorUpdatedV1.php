...
{
    const SCHEMA_ID = 'pbj:jhud:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:event:sponsor-updated:v1';
    const MIXINS = [
