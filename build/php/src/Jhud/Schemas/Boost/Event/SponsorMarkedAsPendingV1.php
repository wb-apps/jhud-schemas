...
namespace Jhud\Schemas\Boost\Event;
...
{
    const SCHEMA_ID = 'pbj:jhud:boost:event:sponsor-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:event:sponsor-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:event:sponsor-marked-as-pending:v1';
    const MIXINS = [
