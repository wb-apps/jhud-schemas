...
namespace Jhud\Schemas\Boost\Request;
...
{
    const SCHEMA_ID = 'pbj:jhud:boost:request:get-sponsor-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:request:get-sponsor-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:request:get-sponsor-history-request:v1';
    const MIXINS = [
