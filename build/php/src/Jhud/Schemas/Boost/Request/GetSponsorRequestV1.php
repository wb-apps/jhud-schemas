...
{
    const SCHEMA_ID = 'pbj:jhud:boost:request:get-sponsor-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:request:get-sponsor-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:request:get-sponsor-request:v1';
    const MIXINS = [
