...
{
    const SCHEMA_ID = 'pbj:jhud:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:request:search-sponsors-response:v1';
    const MIXINS = [
