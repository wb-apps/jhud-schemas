...
{
    const SCHEMA_ID = 'pbj:jhud:boost:request:get-sponsor-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:request:get-sponsor-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:request:get-sponsor-response:v1';
    const MIXINS = [
