...
{
    const SCHEMA_ID = 'pbj:jhud:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:boost:request:search-sponsors-request:v1';
    const MIXINS = [
