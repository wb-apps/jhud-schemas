...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-unpublished:v1';
    const MIXINS = [
