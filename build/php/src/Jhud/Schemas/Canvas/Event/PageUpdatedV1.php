...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-updated:v1';
    const MIXINS = [
