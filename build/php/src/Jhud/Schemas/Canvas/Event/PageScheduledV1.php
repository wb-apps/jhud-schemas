...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-scheduled:v1';
    const MIXINS = [
