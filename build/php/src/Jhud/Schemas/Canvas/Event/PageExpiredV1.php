...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-expired:v1';
    const MIXINS = [
