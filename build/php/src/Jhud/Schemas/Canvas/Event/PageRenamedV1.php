...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-renamed:v1';
    const MIXINS = [
