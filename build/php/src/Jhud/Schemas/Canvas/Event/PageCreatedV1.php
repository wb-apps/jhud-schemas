...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-created:v1';
    const MIXINS = [
