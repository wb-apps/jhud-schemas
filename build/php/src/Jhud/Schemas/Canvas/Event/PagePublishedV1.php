...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-published:v1';
    const MIXINS = [
