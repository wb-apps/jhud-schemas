...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:event:page-deleted:v1';
    const MIXINS = [
