...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:request:search-pages-request:v1';
    const MIXINS = [
