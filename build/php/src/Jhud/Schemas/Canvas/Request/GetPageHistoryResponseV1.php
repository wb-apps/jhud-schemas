...
namespace Jhud\Schemas\Canvas\Request;
...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:request:get-page-history-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:request:get-page-history-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:request:get-page-history-response:v1';
    const MIXINS = [
