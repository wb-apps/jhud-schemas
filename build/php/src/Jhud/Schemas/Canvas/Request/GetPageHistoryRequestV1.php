...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:request:get-page-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:request:get-page-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:request:get-page-history-request:v1';
    const MIXINS = [
