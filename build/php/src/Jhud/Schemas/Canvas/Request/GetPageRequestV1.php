...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:request:get-page-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:request:get-page-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:request:get-page-request:v1';
    const MIXINS = [
