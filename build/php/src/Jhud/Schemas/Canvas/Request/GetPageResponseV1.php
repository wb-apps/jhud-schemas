...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:request:get-page-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:request:get-page-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:request:get-page-response:v1';
    const MIXINS = [
