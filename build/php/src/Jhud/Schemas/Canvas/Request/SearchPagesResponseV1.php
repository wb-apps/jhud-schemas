...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:request:search-pages-response:v1';
    const MIXINS = [
