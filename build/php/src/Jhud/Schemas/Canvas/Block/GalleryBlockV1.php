...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:gallery-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:gallery-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:gallery-block:v1';
    const MIXINS = [
