...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:soundcloud-audio-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:soundcloud-audio-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:soundcloud-audio-block:v1';
    const MIXINS = [
