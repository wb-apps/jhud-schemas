...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:document-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:document-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:document-block:v1';
    const MIXINS = [
