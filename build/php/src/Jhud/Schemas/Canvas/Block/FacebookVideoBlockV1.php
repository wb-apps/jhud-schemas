...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:facebook-video-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:facebook-video-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:facebook-video-block:v1';
    const MIXINS = [
