...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:youtube-playlist-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:youtube-playlist-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:youtube-playlist-block:v1';
    const MIXINS = [
