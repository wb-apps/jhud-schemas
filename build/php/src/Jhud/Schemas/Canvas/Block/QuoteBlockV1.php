...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:quote-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:quote-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:quote-block:v1';
    const MIXINS = [
