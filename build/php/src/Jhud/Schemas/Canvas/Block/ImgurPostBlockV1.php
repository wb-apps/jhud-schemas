...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:imgur-post-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:imgur-post-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:imgur-post-block:v1';
    const MIXINS = [
