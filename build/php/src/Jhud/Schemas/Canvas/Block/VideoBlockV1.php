...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:video-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:video-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:video-block:v1';
    const MIXINS = [
