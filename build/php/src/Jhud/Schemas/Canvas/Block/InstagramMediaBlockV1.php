...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:instagram-media-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:instagram-media-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:instagram-media-block:v1';
    const MIXINS = [
