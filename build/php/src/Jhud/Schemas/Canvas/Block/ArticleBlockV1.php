...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:article-block:v1';
    const MIXINS = [
