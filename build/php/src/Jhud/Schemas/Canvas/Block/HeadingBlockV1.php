...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:block:heading-block:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:block:heading-block';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:block:heading-block:v1';
    const MIXINS = [
