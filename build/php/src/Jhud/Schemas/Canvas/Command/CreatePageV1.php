...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:create-page:v1';
    const MIXINS = [
