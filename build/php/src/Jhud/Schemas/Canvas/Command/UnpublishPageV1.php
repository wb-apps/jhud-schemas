...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:unpublish-page:v1';
    const MIXINS = [
