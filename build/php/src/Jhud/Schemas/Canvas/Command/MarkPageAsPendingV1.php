...
namespace Jhud\Schemas\Canvas\Command;
...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:mark-page-as-pending:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:mark-page-as-pending';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:mark-page-as-pending:v1';
    const MIXINS = [
