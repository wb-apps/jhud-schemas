...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:rename-page:v1';
    const MIXINS = [
