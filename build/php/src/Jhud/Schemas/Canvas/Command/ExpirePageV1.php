...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:expire-page:v1';
    const MIXINS = [
