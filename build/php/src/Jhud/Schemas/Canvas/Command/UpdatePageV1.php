...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:update-page:v1';
    const MIXINS = [
