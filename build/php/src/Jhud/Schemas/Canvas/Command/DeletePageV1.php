...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:delete-page:v1';
    const MIXINS = [
