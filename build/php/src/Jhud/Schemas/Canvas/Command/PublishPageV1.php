...
{
    const SCHEMA_ID = 'pbj:jhud:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'jhud:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'jhud:canvas:command:publish-page:v1';
    const MIXINS = [
