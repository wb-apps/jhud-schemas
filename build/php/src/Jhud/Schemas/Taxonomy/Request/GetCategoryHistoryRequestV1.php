...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:request:get-category-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:request:get-category-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:request:get-category-history-request:v1';
    const MIXINS = [
