...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:request:search-categories-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:request:search-categories-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:request:search-categories-request:v1';
    const MIXINS = [
