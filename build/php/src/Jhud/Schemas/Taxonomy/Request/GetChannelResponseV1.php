...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:request:get-channel-response:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:request:get-channel-response';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:request:get-channel-response:v1';
    const MIXINS = [
