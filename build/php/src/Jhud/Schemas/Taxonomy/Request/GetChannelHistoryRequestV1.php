...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:request:get-channel-history-request:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:request:get-channel-history-request';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:request:get-channel-history-request:v1';
    const MIXINS = [
