...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:event:channel-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:event:channel-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:event:channel-created:v1';
    const MIXINS = [
