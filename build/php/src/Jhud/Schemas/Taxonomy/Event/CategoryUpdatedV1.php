...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:event:category-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:event:category-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:event:category-updated:v1';
    const MIXINS = [
