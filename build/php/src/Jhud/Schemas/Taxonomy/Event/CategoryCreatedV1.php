...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:event:category-created:v1';
    const MIXINS = [
