...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:event:category-deleted:v1';
    const MIXINS = [
