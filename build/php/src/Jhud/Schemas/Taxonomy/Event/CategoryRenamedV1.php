...
namespace Jhud\Schemas\Taxonomy\Event;
...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:event:category-renamed:v1';
    const MIXINS = [
