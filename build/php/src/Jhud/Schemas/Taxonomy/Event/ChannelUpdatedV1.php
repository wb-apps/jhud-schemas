...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:event:channel-updated:v1';
    const MIXINS = [
