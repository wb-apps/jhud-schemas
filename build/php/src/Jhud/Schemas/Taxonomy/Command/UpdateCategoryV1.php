...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:update-category:v1';
    const MIXINS = [
