...
namespace Jhud\Schemas\Taxonomy\Command;
...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:delete-category:v1';
    const MIXINS = [
