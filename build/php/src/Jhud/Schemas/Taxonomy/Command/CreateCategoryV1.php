...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:create-category:v1';
    const MIXINS = [
