...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:rename-channel:v1';
    const MIXINS = [
