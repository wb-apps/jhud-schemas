...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:create-channel:v1';
    const MIXINS = [
