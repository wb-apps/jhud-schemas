...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:update-channel:v1';
    const MIXINS = [
