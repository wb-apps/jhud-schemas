...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:rename-category:v1';
    const MIXINS = [
