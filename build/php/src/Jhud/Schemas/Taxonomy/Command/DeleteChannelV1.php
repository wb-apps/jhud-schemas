...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:command:delete-channel:v1';
    const MIXINS = [
