...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:node:category:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:node:category';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:node:category:v1';
    const MIXINS = [
