...
{
    const SCHEMA_ID = 'pbj:jhud:taxonomy:node:channel:1-0-0';
    const SCHEMA_CURIE = 'jhud:taxonomy:node:channel';
    const SCHEMA_CURIE_MAJOR = 'jhud:taxonomy:node:channel:v1';
    const MIXINS = [
